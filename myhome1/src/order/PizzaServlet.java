...
public class PizzaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pizza_map.put("cheeze", new HashMap<String, String>() {{ put("name", "치즈피자"); put("price", "5000"); }});
		pizza_map.put("combi", new HashMap<String, String>() {{ put("name", "콤비네이션피자"); put("price", "6000"); }});
		pizza_map.put("potato", new HashMap<String, String>() {{ put("name", "포테이토피자"); put("price", "5000"); }});
		pizza_map.put("goguma", new HashMap<String, String>() {{ put("name", "치즈피자"); put("price", "5000"); }});
		pizza_map.put("bullgogi", new HashMap<String, String>() {{ put("name", "치즈피자"); put("price", "5000"); }});
		...
		topping_map.put("pine", new HashMap<String, String>() {{ put("name", "파인애플토핑"); put("price", "2000"); }});
		topping_map.put("cheeze", new HashMap<String, String>() {{ put("name", "치즈토핑"); put("price", "2000"); }});
		topping_map.put("crust", new HashMap<String, String>() {{ put("name", "치즈크러스트"); put("price", "2000"); }});
		topping_map.put("byte", new HashMap<String, String>() {{ put("name", "치즈바이트"); put("price", "3000"); }});
		
		HashMap<String, HashMap<String, String>> side_map = new HashMap();
		side_map.put("ovenchkin", new HashMap<String, String>() {{ put("name", "오픈구이통닭"); put("price", "9000"); }});
		side_map.put("chkining", new HashMap<String, String>() {{ put("name", "치킨스틱&윙"); put("price", "4900"); }});
		side_map.put("chkinspaghet", new HashMap<String, String>() {{ put("name", "치즈오픈스파게티"); put("price", "4000"); }});
		side_map.put("shrimpedge", new HashMap<String, String>() {{ put("name", "새우링&웨지감자"); put("price", "3500"); }});
		side_map.put("garlicpptato", new HashMap<String, String>() {{ put("name", "갈릭포테이토"); put("price", "3000"); }});
